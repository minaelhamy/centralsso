...
const config = {
  ...
  baseUrl: 'https://sso.thecoolbits.com/',
  baseAssetsUrl: 'https://sso.thecoolbits.com/',
  siteName: 'Central SSO',
  siteTitle: 'A Central Single Sign On to make easier sign-in to all of your applications.',
  siteDescription: 'A Central Single Sign On to make easier sign-in to all of your applications.',
  authorName: 'Mina Elhamy Samy',
  authorWebsite: 'https://minaelhamysamy.com',
  authorEmail: 'minaelhamy@gmail.com',
  ...
  social: [
    ...
    { name: 'github', link: 'https://github.com/minaelhamy' },
  ...
  recipientEmailAddress: 'minaelhamy@gmail.com',
