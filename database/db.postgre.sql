...
CREATE TABLE menus (
  ...
  child text,
  status int DEFAULT NULL,
  created_at numeric(20) DEFAULT NULL,
  modified_at numeric(20) DEFAULT NULL,
...
-- INDEX
-- ----------------------------
CREATE INDEX index_activationusers ON activationusers (username);
CREATE INDEX index_data_ssos ON data_ssos (username, key);
